...
print("🛠️ Membuat skema tabel di PostgreSQL...")
# We must ensure PostgreSQL connection in utils is ready. 
# But wait, utils.py relies on .env too.
init_db()
    ...
    try:
        ...
        if not df.empty:
            ...
            if table == "users":
                ...
                print("   ⚠️ Mereset seluruh password user menjadi 'admin123' dengan Bcrypt...")
            ...
            print(f"   ℹ️ Tabel kosong, dilewati.")
    except Exception as e:
